...
options, operands = getopt(sys.argv[1:], "", ["idir_fds=", "proc_dt=", "comp=", "vza_thresh_max=", "scratch_dir=" ,"cache_dir="])
for o,v in options:
    if o == "--idir_fds":
        idir_fds = v
    if o == "--proc_dt":
...
return_dict= {}     
utils.load_seviri(idir_fds, proc_dt, return_dict, comp, vza_thresh_max, 'fds', worp_opts)
